...
L["\"raid\" will show all collectibles that can be collected from a raid"] = WrapTextInColor("\"raid\"", DARKYELLOW_FONT_COLOR).." will show all collectibles that can be collected from a raid"
L["\"10\" will show all collectibles that can be collected from a legacy 10 player raid (Normal or Heroic)"] = WrapTextInColor("\"10\"", DARKYELLOW_FONT_COLOR).." will show all collectibles that can be collected from a legacy 10 player raid (Normal or Heroic)"
L["\"fel\" will show all collectibles and instances that contain \"fel\" in the name"] = WrapTextInColor("\"fel\"", DARKYELLOW_FONT_COLOR).." will show all collectibles and instances that contain \"fel\" in the name"
L["\"mythic\" will show all collectibles that can be obtained from a Mythic dungeon or raid"] = WrapTextInColor("\"mythic\"", DARKYELLOW_FONT_COLOR).." will show all collectibles that can be obtained from a Mythic dungeon or raid"
L["\"lfr\" will show all collectibles that can be obtained from Raid Finder (LFR) difficulty raids"] = WrapTextInColor("\"lfr\"", DARKYELLOW_FONT_COLOR).." will show all collectibles that can be obtained from Raid Finder (LFR) difficulty raids"
