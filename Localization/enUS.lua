...
L["May require completion of the quest NZOTH_ASSAULTS_QUEST to access raid entrances"] = "May require completion of the quest |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 58582 or 58496) or select(1, UnitFactionGroup("player")) == "Horde" and "Return of the Black Prince" or "An Unwelcome Advisor").." to access raid entrances"
...
L["Debug messages"] = "Debug messages"
L["enabled"] = "enabled"
L["disabled"] = "disabled"
L["Mini-window inside instances has been"] = "Mini-window inside instances has been"
...
L["Search by decor/instance name, instance type, difficulty, or expansion"] = "Search by decor/instance name, instance type, difficulty, or expansion"
L["Scale"] = "Scale"
L["Use TomTom waypoints"] = "Use TomTom waypoints"
L["Show Available Only"] = "Show Available Only"
L["Only show items that can still be collected"] = "Only show items that can still be collected"
L["Also show collectibles you already own"] = "Also show collectibles you already own"
L["Use TomTom waypoints instead of Blizzard map pins"] = "Use TomTom waypoints instead of Blizzard map pins"
L["Show Owned"] = "Show Owned"
L["How To Use:"] = "How To Use:"
L["Find the collectible you want to collect in the list and click the button for the difficulty you want to run on to make sure it is updated."] = "Find the collectible you want to collect in the list and click the button for the difficulty you want to run on to make sure it is updated."
...
L["A button will also be disabled for legacy raids completed on another difficulty since those lockouts are shared across difficulties."] = "A button will also be disabled for legacy raids completed on another difficulty since those lockouts are shared across difficulties."
L["Click the star icon on any item to mark or unmark it as a favorite. Favorited items are always pinned to the top of the list."] = "Click the star icon on any item to mark or unmark it as a favorite. Favorited items are always pinned to the top of the list."
L["Click a column header to sort the list by that column. Click again to reverse the order, or a third time to clear the sort."] = "Click a column header to sort the list by that column. Click again to reverse the order, or a third time to clear the sort."
L["Click on a collectible's icon to preview it in a dressing room window."] = "Click on a collectible's icon to preview it in a dressing room window."
L["Use the checkboxes at the bottom of the window to control which items appear in the list."] = "Use the checkboxes at the bottom of the window to control which items appear in the list."
L["Enable the mini-window in settings or with /ich mini to see available collectibles while inside an instance."] = "Enable the mini-window in settings or with "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich mini").." to see available collectibles while inside an instance."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").." will show all collectibles that can be collected from a dungeon"
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").." will show all collectibles dropped by The Lich King"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").." will show all collectibles from instances in Northrend"
L["Other expansion abbreviations are also supported: tbc, cata, mop, wod, bfa, sl, df, tww"] = "Other expansion abbreviations are also supported: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tbc")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("cata")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("mop")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("wod")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("bfa")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("sl")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("df")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tww")
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").." will show all collectibles from Wrath of the Lich King or Cataclysm"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").." will show all dungeon collectibles not available on Heroic difficulty"
L["Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. (wrath|cata) !heroic"] = "Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("(wrath|cata) !heroic")
L["Name"] = "Name"
L["Instance"] = "Instance"
...
L["Waypoint tracking on the minimap may not always appear until you are in a specific zone. For example, an arrow pointing towards Throne of Thunder will only appear when you are on the Isle of Thunder."] = "Waypoint tracking on the minimap may not always appear until you are in a specific zone. For example, an arrow pointing towards "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Throne of Thunder").." will only appear when you are on the "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Isle of Thunder").."."
...
L["Originally rewarded for completing the achievement Master of the Turbulent Timeways IV. Can now be purchased from any Timewalking vendor."] = "Originally rewarded for completing the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61394)) or "Master of the Turbulent Timeways IV")..". Can now be purchased from any Timewalking vendor."
...
L["Obtainable for free by earning the achievement Argussian Reach"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42627)) or "Argussian Reach")
L["Obtainable for free by earning the achievement Timeworn Keystone Master"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42689)) or "Timeworn Keystone Master")
L["Obtainable for free by earning the achievement Highmountain Tribe"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42547)) or "Highmountain Tribe")
L["Obtainable for free by earning the achievement Defending the Broken Isles III"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42675)) or "Defending the Broken Isles III")
L["Obtainable for free by earning the achievement The Nightfallen"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42628)) or "The Nightfallen")
L["Obtainable for free by earning the achievement Dreamweavers"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42619)) or "Dreamweavers")
L["Obtainable for free by earning the achievement Power of the Obelisks II"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61060)) or "Power of the Obelisks II")
L["Obtainable for free by earning the achievement Broken Isles Dungeoneer"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42692)) or "Broken Isles Dungeoneer")
L["Obtainable for free by earning the achievement Heroic Broken Isles World Quests III"] = "Obtainable for free by earning the achievement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61054)) or "Heroic Broken Isles World Quests III")
...
L["Click to favorite. Favorites always appear at the top of the list."] = "Click to favorite. Favorites always appear at the top of the list."
L["Click to unfavorite"] = "Click to unfavorite"
L["Sort ascending"] = "Sort ascending"
L["Sort descending"] = "Sort descending"
L["Clear sort"] = "Clear sort"

--- World Tour ---
L["World Tour"] = "World Tour"
L["No world tour stop selected"] = "No world tour stop selected"
L["Start"] = "Start"
L["Stop"] = "Stop"
L["Prev"] = "Prev"
L["Next"] = "Next"
L["Reset"] = "Reset"
L["Select at least one collectible type to continue the tour"] = "Select at least one collectible type to continue the tour"
L["Invalid world tour command."] = "Invalid world tour command."
