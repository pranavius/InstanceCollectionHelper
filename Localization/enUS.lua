...
L["Obtained by using an Amani Hex Stick on Forest Frogs"] = "Obtained by using an "..(select(2, C_Item.GetItemInfo(33865)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("[Amani Hex Stick]")).." on "..GREEN_FONT_COLOR:WrapTextInColorCode("Forest Frogs")
...
L["\"wotlk\" or \"wrath\" will show all collectibles that can be obtained from Wrath of the Lich King instances"] = "\"wotlk\" or \"wrath\" will show all collectibles that can be obtained from Wrath of the Lich King instances"
L["Name"] = "Name"
L["Instance"] = "Instance"
...
L["\"raid\" will show all mounts that can be collected from a raid"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"raid\"").." will show all mounts that can be collected from a raid"
L["\"10\" will show all mounts that can be collected from a legacy 10 player raid (Normal or Heroic)"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"10\"").." will show all mounts that can be collected from a legacy 10 player raid (Normal or Heroic)"
L["\"fel\" will show all mounts and instances that contain \"fel\" in the name"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"fel\"").." will show all mounts and instances that contain \"fel\" in the name"
L["\"mythic\" will show all mounts that can be obtained from a Mythic dungeon or raid"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"mythic\"").." will show all mounts that can be obtained from a Mythic dungeon or raid"
L["\"lfr\" will show all mounts that can be obtained from Raid Finder (LFR) difficulty raids"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lfr\"").." will show all mounts that can be obtained from Raid Finder (LFR) difficulty raids"
