...
L["\"raid\" will show all collectibless that can be collected from a raid"] = WrapTextInColor("\"raid\"", DARKYELLOW_FONT_COLOR).." will show all collectibless that can be collected from a raid"
L["\"10\" will show all collectibless that can be collected from a legacy 10 player raid (Normal or Heroic)"] = WrapTextInColor("\"10\"", DARKYELLOW_FONT_COLOR).." will show all collectibless that can be collected from a legacy 10 player raid (Normal or Heroic)"
L["\"fel\" will show all collectibless and instances that contain \"fel\" in the name"] = WrapTextInColor("\"fel\"", DARKYELLOW_FONT_COLOR).." will show all collectibless and instances that contain \"fel\" in the name"
L["\"mythic\" will show all collectibless that can be obtained from a Mythic dungeon or raid"] = WrapTextInColor("\"mythic\"", DARKYELLOW_FONT_COLOR).." will show all collectibless that can be obtained from a Mythic dungeon or raid"
L["\"lfr\" will show all collectibless that can be obtained from Raid Finder (LFR) difficulty raids"] = WrapTextInColor("\"lfr\"", DARKYELLOW_FONT_COLOR).." will show all collectibless that can be obtained from Raid Finder (LFR) difficulty raids"
L["\"wotlk\" or \"wrath\" will show all collectibless that can be obtained from Wrath of the Lich King instances"] = "\"wotlk\" or \"wrath\" will show all collectibless that can be obtained from Wrath of the Lich King instances"
L["Name"] = "Name"
L["Instance"] = "Instance"
