...
L["Requires four (4) Delicious Sporesnack that are earned after killing Rotmire on any difficulty."] = "Требует четыре (4) "..(select(2, C_Item.GetItemInfo(269245)) or EPIC_PURPLE_COLOR:WrapTextInColorCode("[Delicious Sporesnack]"))..", которые можно получить после убийства "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Гнилотопа").." на любой сложности."
...
L["Can only be looted and used by a Druid"] = "Может быть подобран и использован только "..WrapTextInColor(ICH_GetClassName(11, "Друид"), C_ClassColor.GetClassColor("DRUID"))
...
L["Can only be looted and used by a Demon Hunter"] = "Может быть подобран и использован только "..WrapTextInColor(ICH_GetClassName(12, "Охотник на демонов"), C_ClassColor.GetClassColor("DEMONHUNTER"))
...
L["Access to the raid entrance requires completing the quest ETERNAL_PALACE_QUEST"] = "Доступ ко входу в рейд требует выполнения задания |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 55799 or 56325) or select(1, UnitFactionGroup("player")) == "Horde" and "Прилив меняется" or "Смена течения")
...
L["Debug messages"] = "Отладочные сообщения"
L["enabled"] = "включено"
L["disabled"] = "выключено"
L["Mini-window inside instances has been"] = "Мини-окно в подземельях было"
...
L["Search by decor/instance name, instance type, difficulty, or expansion"] = "Поиск по названию декора/подземелья, типу подземелья, сложности или дополнению"
L["Scale"] = "Масштаб"
L["Use TomTom waypoints"] = "Использовать точки маршрута TomTom"
L["Show Available Only"] = "Показывать только доступные"
L["Only show items that can still be collected"] = "Показывать только предметы, которые ещё можно получить"
L["Also show collectibles you already own"] = "Также показывать предметы, которые уже есть в коллекции"
...
L["Use the checkboxes at the bottom of the window to control which items appear in the list."] = "Используйте флажки в нижней части окна, чтобы управлять тем, какие предметы отображаются в списке."
L["Enable the mini-window in settings or with /ich mini to see available collectibles while inside an instance."] = "Включите мини-окно в настройках или с помощью "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich mini")..", чтобы видеть доступные коллекционные предметы внутри подземелья."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").." покажет все предметы коллекции из подземелий"
...
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").." покажет все предметы коллекции, выпадающие с Короля-Лича"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").." покажет все предметы коллекции из подземелий Нордскола"
L["Other expansion abbreviations are also supported: tbc, cata, mop, wod, bfa, sl, df, tww"] = "Также поддерживаются другие сокращения дополнений: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tbc")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("cata")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("mop")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("wod")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("bfa")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("sl")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("df")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tww")
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").." покажет все предметы коллекции из Wrath of the Lich King или Cataclysm"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").." покажет все предметы коллекции из подземелий, недоступные на героической сложности"
L["Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. (wrath|cata) !heroic"] = "Соседние термины по умолчанию объединяются с помощью AND. Используйте скобки для группировки терминов, например: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("(wrath|cata) !heroic")
L["Name"] = "Имя"
...
L["Originally rewarded for completing the achievement Master of the Turbulent Timeways IV. Can now be purchased from any Timewalking vendor."] = "Изначально выдавалось за выполнение достижения "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61394)) or "Master of the Turbulent Timeways IV")..". Теперь можно купить у любого торговца путешествием во времени"
...
L["Obtainable for free by reaching level 80 with a Death Knight Timerunner and earning the achievement Timerunner: Death Knight"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(6, "Рыцарь смерти"), C_ClassColor.GetClassColor("DEATHKNIGHT")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42685)) or "Timerunner: Death Knight")
L["Obtainable for free by reaching level 80 with a Demon Hunter Timerunner and earning the achievement Timerunner: Demon Hunter"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(12, "Охотник на демонов"), C_ClassColor.GetClassColor("DEMONHUNTER")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61087)) or "Timerunner: Demon Hunter")
L["Obtainable for free by reaching level 80 with a Druid Timerunner and earning the achievement Timerunner: Druid"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(11, "Друид"), C_ClassColor.GetClassColor("DRUID")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61086)) or "Timerunner: Druid")
L["Obtainable for free by reaching level 80 with a Hunter Timerunner and earning the achievement Timerunner: Hunter"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(3, "Охотник"), C_ClassColor.GetClassColor("HUNTER")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42687)) or "Timerunner: Hunter")
L["Obtainable for free by reaching level 80 with a Mage Timerunner and earning the achievement Timerunner: Mage"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(8, "Маг"), C_ClassColor.GetClassColor("MAGE")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61089)) or "Timerunner: Mage")
L["Obtainable for free by reaching level 80 with a Monk Timerunner and earning the achievement Timerunner: Monk"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(10, "Монах"), C_ClassColor.GetClassColor("MONK")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61085)) or "Timerunner: Monk")
L["Obtainable for free by reaching level 80 with a Paladin Timerunner and earning the achievement Timerunner: Paladin"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(2, "Паладин"), C_ClassColor.GetClassColor("PALADIN")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42504)) or "Timerunner: Paladin")
L["Obtainable for free by reaching level 80 with a Priest Timerunner and earning the achievement Timerunner: Priest"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(5, "Жрец"), C_ClassColor.GetClassColor("PRIEST")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61088)) or "Timerunner: Priest")
L["Obtainable for free by reaching level 80 with a Rogue Timerunner and earning the achievement Timerunner: Rogue"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(4, "Разбойник"), C_ClassColor.GetClassColor("ROGUE")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61084)) or "Timerunner: Rogue")
L["Obtainable for free by reaching level 80 with a Shaman Timerunner and earning the achievement Timerunner: Shaman"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(7, "Шаман"), C_ClassColor.GetClassColor("SHAMAN")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42686)) or "Timerunner: Shaman")
L["Obtainable for free by reaching level 80 with a Warlock Timerunner and earning the achievement Timerunner: Warlock"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(9, "Чернокнижник"), C_ClassColor.GetClassColor("WARLOCK")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61090)) or "Timerunner: Warlock")
L["Obtainable for free by reaching level 80 with a Warrior Timerunner and earning the achievement Timerunner: Warrior"] = "Можно получить бесплатно, достигнув 80 уровня с Хронобегуном "..WrapTextInColor(ICH_GetClassName(1, "Воин"), C_ClassColor.GetClassColor("WARRIOR")).." и получив достижение "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42684)) or "Timerunner: Warrior")
