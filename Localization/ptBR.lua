...
L["Obtained by using an Amani Hex Stick on Forest Frogs"] = "Obtido ao usar um "..(select(2, C_Item.GetItemInfo(33865)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("[Vareta de Bruxaria Amani]")).." em "..GREEN_FONT_COLOR:WrapTextInColorCode("Sapos de Floresta")
...
L["\"raid\" will show all mounts that can be collected from a raid"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"raide\"").." mostrará todas as montarias que podem ser coletadas em uma raide"
L["\"10\" will show all mounts that can be collected from a legacy 10 player raid (Normal or Heroic)"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"10\"").." mostrará todas as montarias que podem ser coletadas em uma raide de 10 jogadores de legado (Normal ou Heróico)"
L["\"fel\" will show all mounts and instances that contain \"fel\" in the name"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"fel\"").." mostrará todas as montarias e instâncias que contêm \"fel\" no nome"
L["\"mythic\" will show all mounts that can be obtained from a Mythic dungeon or raid"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"mítico\"").." mostrará todas as montarias que podem ser obtidas em um calabouço mítico ou raide"
L["\"lfr\" will show all mounts that can be obtained from Raid Finder (LFR) difficulty raids"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lfr\"").." mostrará todas as montarias que podem ser obtidas em raides na dificuldade Localizador de Raides (LFR)"
