...
L["May require completion of the quest NZOTH_ASSAULTS_QUEST to access raid entrances"] = "O acesso às entradas do raide pode exigir completar a missão |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 58582 or 58496) or select(1, UnitFactionGroup("player")) == "Horde" and "Return of the Black Prince" or "An Unwelcome Advisor")
...
L["Requires four (4) Delicious Sporesnack that are earned after killing Rotmire on any difficulty."] = "Requer quatro (4) "..(select(2, C_Item.GetItemInfo(269245)) or EPIC_PURPLE_COLOR:WrapTextInColorCode("[Delicious Sporesnack]")).." obtidos após derrotar "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Necrocharco").." em qualquer dificuldade."
...
L["Can only be looted and used by a Druid"] = "Só pode ser saqueado e usado por um "..WrapTextInColor(ICH_GetClassName(11, "Druid"), C_ClassColor.GetClassColor("DRUID"))
...
L["Can only be looted and used by a Demon Hunter"] = "Só pode ser saqueado e usado por um "..WrapTextInColor(ICH_GetClassName(12, "Demon Hunter"), C_ClassColor.GetClassColor("DEMONHUNTER"))
...
L["Dropped by The Lanticore, which has a random chance to spawn after killing Orebender Gor'ashan"] = "Obtido de "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("A Lantícora")..", que tem uma chance aleatória de aparecer após matar "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Dobrarrocha Gor'ashan")
...
L["Debug messages"] = "Mensagens de depuração"
L["enabled"] = "ativado"
L["disabled"] = "desativado"
L["Mini-window inside instances has been"] = "A mini-janela dentro de instâncias foi"
...
--- Icon Tooltip ---
L["Track available collectibles from instances and easily set required instance difficulty"] = "Rastrear colecionáveis disponíveis de instâncias e definir facilmente a dificuldade requerida da instância"
L["Click to open the AddOn window"] = GREEN_FONT_COLOR:WrapTextInColorCode("Clique").." para abrir a janela do addon"
L["Right-click to open the settings window"] = GREEN_FONT_COLOR:WrapTextInColorCode("Clique com o botão direito").." para abrir a janela de configurações"
L["Type /ich help in the chat window for available slash commands"] = "Digite "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich help").." na janela de chat para comandos disponíveis"
...
L["Search by decor/instance name, instance type, difficulty, or expansion"] = "Pesquisar por nome de decoração/instância, tipo de instância, dificuldade ou expansão"
L["Scale"] = "Escala"
L["Use TomTom waypoints"] = "Usar waypoints de TomTom"
L["Show Available Only"] = "Mostrar apenas disponíveis"
L["Only show items that can still be collected"] = "Mostrar apenas itens que ainda podem ser coletados"
L["Also show collectibles you already own"] = "Também mostrar colecionáveis que você já possui"
L["Use TomTom waypoints instead of Blizzard map pins"] = "Usar waypoints de TomTom em vez de marcadores de mapa da Blizzard"
L["Show Owned"] = "Mostrar itens possuídos"
L["How To Use:"] = "Como usar:"
L["Find the collectible you want to collect in the list and click the button for the difficulty you want to run on to make sure it is updated."] = "Encontre a colecionável que deseja coletar na lista e clique no botão da dificuldade em que quer executar para garantir que esteja atualizada."
...
L["A button will also be disabled for legacy raids completed on another difficulty since those lockouts are shared across difficulties."] = "Um botão também será desativado para raides de legado concluídos em outra dificuldade, pois esses bloqueios são compartilhados entre dificuldades."
L["Click the star icon on any item to mark or unmark it as a favorite. Favorited items are always pinned to the top of the list."] = "Clique no ícone de estrela de qualquer item para marcá-lo ou desmarcá-lo como favorito. Os favoritos são sempre fixados no topo da lista."
L["Click a column header to sort the list by that column. Click again to reverse the order, or a third time to clear the sort."] = "Clique no cabeçalho de uma coluna para ordenar a lista por essa coluna. Clique novamente para inverter a ordem, ou uma terceira vez para remover a ordenação."
L["Click on a collectible's icon to preview it in a dressing room window."] = "Clique no ícone de um colecionável para visualizá-lo na janela do provador."
L["Use the checkboxes at the bottom of the window to control which items appear in the list."] = "Use as caixas de seleção na parte inferior da janela para controlar quais itens aparecem na lista."
L["Enable the mini-window in settings or with /ich mini to see available collectibles while inside an instance."] = "Ative a mini-janela nas configurações ou com "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich mini").." para ver os colecionáveis disponíveis dentro de uma instância."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").." mostrará todas as colecionáveis que podem ser obtidas de uma masmorra"
...
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").." mostrará todos os colecionáveis obtidos do Rei Lich"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").." mostrará todos os colecionáveis de instâncias em Nortúndria"
L["Other expansion abbreviations are also supported: tbc, cata, mop, wod, bfa, sl, df, tww"] = "Outras abreviações de expansão também são suportadas: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tbc")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("cata")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("mop")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("wod")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("bfa")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("sl")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("df")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tww")
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").." mostrará todos os colecionáveis de Wrath of the Lich King ou Cataclysm"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").." mostrará todos os colecionáveis de masmorra não disponíveis na dificuldade Heroica"
L["Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. (wrath|cata) !heroic"] = "Termos adjacentes são combinados com AND por padrão. Use parênteses para agrupar termos, ex.: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("(wrath|cata) !heroic")
L["Name"] = "Nome"
...
L["Waypoint tracking on the minimap may not always appear until you are in a specific zone. For example, an arrow pointing towards Throne of Thunder will only appear when you are on the Isle of Thunder."] = "O rastreamento de marcador no minimapa pode não aparecer até você estar em uma zona específica. Por exemplo, uma seta apontando para o "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Trono do Trovão").." só aparecerá quando você estiver na "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Ilha do Trovão").."."
...
L["Originally rewarded for completing the achievement Master of the Turbulent Timeways IV. Can now be purchased from any Timewalking vendor."] = "Originalmente recompensado por completar o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61394)) or "Master of the Turbulent Timeways IV")..". Agora pode ser comprado com qualquer vendedor de Caminhada Temporal"
...
L["Obtainable for free by earning the achievement The Armies of Legionfall"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42655)) or "The Armies of Legionfall")
L["Obtainable for free by earning the achievement Argussian Reach"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42627)) or "Argussian Reach")
L["Obtainable for free by earning the achievement Timeworn Keystone Master"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42689)) or "Timeworn Keystone Master")
L["Obtainable for free by earning the achievement Highmountain Tribe"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42547)) or "Highmountain Tribe")
L["Obtainable for free by earning the achievement Defending the Broken Isles III"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42675)) or "Defending the Broken Isles III")
L["Obtainable for free by earning the achievement The Nightfallen"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42628)) or "The Nightfallen")
L["Obtainable for free by earning the achievement Dreamweavers"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42619)) or "Dreamweavers")
L["Obtainable for free by earning the achievement Power of the Obelisks II"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61060)) or "Power of the Obelisks II")
L["Obtainable for free by earning the achievement Broken Isles Dungeoneer"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42692)) or "Broken Isles Dungeoneer")
L["Obtainable for free by earning the achievement Heroic Broken Isles World Quests III"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61054)) or "Heroic Broken Isles World Quests III")
L["Obtainable for free by earning the achievement The Wardens"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61218)) or "The Wardens")
L["Obtainable for free by earning the achievement Court of Farondis"] = "Obtido gratuitamente ao obter o feito "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42318)) or "Court of Farondis")
...
L["Click to favorite. Favorites always appear at the top of the list."] = "Clique para adicionar aos favoritos. Os favoritos sempre aparecem no topo da lista."
L["Click to unfavorite"] = "Clique para remover dos favoritos"
L["Sort ascending"] = "Classificar em ordem crescente"
L["Sort descending"] = "Classificar em ordem decrescente"
L["Clear sort"] = "Limpar ordenação"

--- World Tour ---
L["World Tour"] = "Turnê Mundial"
L["No world tour stop selected"] = "Nenhuma parada da turnê mundial selecionada"
L["Start"] = "Iniciar"
L["Stop"] = "Parar"
L["Prev"] = "Anterior"
L["Next"] = "Próximo"
L["Reset"] = "Redefinir"
L["Select at least one collectible type to continue the tour"] = "Selecione pelo menos um tipo de colecionável para continuar a turnê"
L["Invalid world tour command."] = "Comando de turnê mundial inválido."