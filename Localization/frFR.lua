...
L["May require completion of the quest NZOTH_ASSAULTS_QUEST to access raid entrances"] = "L'accès aux entrées du raid peut nécessiter de compléter la quête |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 58582 or 58496) or select(1, UnitFactionGroup("player")) == "Horde" and "Return of the Black Prince" or "An Unwelcome Advisor")
...
L["Requires four (4) Delicious Sporesnack that are earned after killing Rotmire on any difficulty."] = "Nécessite quatre (4) "..(select(2, C_Item.GetItemInfo(269245)) or EPIC_PURPLE_COLOR:WrapTextInColorCode("[Delicious Sporesnack]")).." gagnés en tuant "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Embourbe-pourri").." dans n'importe quel mode."
...
L["Can only be looted and used by a Druid"] = "Ne peut être pillé et utilisé que par un "..WrapTextInColor(ICH_GetClassName(11, "Druide"), C_ClassColor.GetClassColor("DRUID"))
...
L["Can only be looted and used by a Demon Hunter"] = "Ne peut être pillé et utilisé que par un "..WrapTextInColor(ICH_GetClassName(12, "Chasseur de démons"), C_ClassColor.GetClassColor("DEMONHUNTER"))
...
L["Access to the raid entrance requires completing the quest ETERNAL_PALACE_QUEST"] = "L'accès à l'entrée du raid nécessite de compléter la quête |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 55799 or 56325) or select(1, UnitFactionGroup("player")) == "Horde" and "La marée tourne" or "Le tournant de la marée")
...
L["Debug messages"] = "Messages de débogage"
L["enabled"] = "activé"
L["disabled"] = "désactivé"
L["Mini-window inside instances has been"] = "La mini-fenêtre dans les instances a été"
...
--- Icon Tooltip ---
L["Track available collectibles from instances and easily set required instance difficulty"] = "Suivez les objets de collection disponibles dans les instances et définissez facilement la difficulté d'instance requise"
L["Click to open the AddOn window"] = GREEN_FONT_COLOR:WrapTextInColorCode("Cliquez").." pour ouvrir la fenêtre de l'extension"
L["Right-click to open the settings window"] = GREEN_FONT_COLOR:WrapTextInColorCode("Clic droit").." pour ouvrir la fenêtre des paramètres"
L["Type /ich help in the chat window for available slash commands"] = "Tapez "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich help").." dans la fenêtre de discussion pour les commandes disponibles"
...
L["Search by decor/instance name, instance type, difficulty, or expansion"] = "Rechercher par nom de décoration/instance, type d'instance, difficulté ou extension"
L["Scale"] = "Échelle"
L["Use TomTom waypoints"] = "Utiliser les points de passage TomTom"
L["Show Available Only"] = "Afficher uniquement les disponibles"
L["Only show items that can still be collected"] = "Afficher uniquement les objets qui peuvent encore être collectés"
L["Also show collectibles you already own"] = "Afficher également les objets de collection déjà possédés"
L["Use TomTom waypoints instead of Blizzard map pins"] = "Utiliser les points de passage TomTom plutôt que les épingles de carte Blizzard"
L["Show Owned"] = "Afficher possédés"
L["How To Use:"] = "Comment utiliser :"
L["Find the collectible you want to collect in the list and click the button for the difficulty you want to run on to make sure it is updated."] = "Trouvez le collectionnable souhaité dans la liste et cliquez sur le bouton de la difficulté souhaitée pour vous assurer qu'elle est mise à jour."
...
L["A button will also be disabled for legacy raids completed on another difficulty since those lockouts are shared across difficulties."] = "Un bouton sera également désactivé pour les raids héritage effectués en d'autre difficulté car ces verrouillages sont partagés entre les difficultés."
L["Click the star icon on any item to mark or unmark it as a favorite. Favorited items are always pinned to the top of the list."] = "Cliquez sur l'icône étoile d'un élément pour l'ajouter ou le retirer des favoris. Les favoris sont toujours épinglés en haut de la liste."
L["Click a column header to sort the list by that column. Click again to reverse the order, or a third time to clear the sort."] = "Cliquez sur un en-tête de colonne pour trier la liste par cette colonne. Cliquez à nouveau pour inverser l'ordre, ou une troisième fois pour supprimer le tri."
L["Click on a collectible's icon to preview it in a dressing room window."] = "Cliquez sur l'icône d'un collectionnable pour le prévisualiser dans la fenêtre de la salle d'essayage."
L["Use the checkboxes at the bottom of the window to control which items appear in the list."] = "Utilisez les cases à cocher en bas de la fenêtre pour contrôler quels objets apparaissent dans la liste."
L["Enable the mini-window in settings or with /ich mini to see available collectibles while inside an instance."] = "Activez la mini-fenêtre dans les paramètres ou avec "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich mini").." pour voir les objets de collection disponibles dans une instance."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").." affichera tous les collectionnables obtenables dans un donjon"
...
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").." affichera tous les collectionnables lâchés par le Roi-Liche"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").." affichera tous les collectionnables des instances de Norfendre"
L["Other expansion abbreviations are also supported: tbc, cata, mop, wod, bfa, sl, df, tww"] = "D'autres abréviations d'extensions sont également supportées : "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tbc")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("cata")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("mop")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("wod")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("bfa")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("sl")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("df")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tww")
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").." affichera tous les collectionnables de Wrath of the Lich King ou Cataclysm"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").." affichera tous les collectionnables de donjon non disponibles en difficulté Héroïque"
L["Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. (wrath|cata) !heroic"] = "Les termes adjacents sont combinés avec AND par défaut. Utilisez des parenthèses pour regrouper les termes, p. ex. "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("(wrath|cata) !heroic")
L["Name"] = "Nom"
L["Instance"] = "Instance"
...
L["Waypoint tracking on the minimap may not always appear until you are in a specific zone. For example, an arrow pointing towards Throne of Thunder will only appear when you are on the Isle of Thunder."] = "Le suivi de point de passage sur la minicarte peut ne pas s'afficher tant que vous n'êtes pas dans une zone spécifique. Par exemple, une flèche pointant vers le "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Trône du tonnerre").." n'apparaîtra que lorsque vous vous trouvez sur l'"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Île du Tonnerre").."."
...
L["Originally rewarded for completing the achievement Master of the Turbulent Timeways IV. Can now be purchased from any Timewalking vendor."] = "Récompense initiale de l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61394)) or "Master of the Turbulent Timeways IV")..". Peut désormais être acheté auprès de n'importe quel marchand de Voyage dans le temps."
...
L["Obtainable for free by reaching level 80 with a Death Knight Timerunner and earning the achievement Timerunner: Death Knight"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(6, "Chevalier de la mort"), C_ClassColor.GetClassColor("DEATHKNIGHT")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42685)) or "Timerunner: Death Knight")
L["Obtainable for free by reaching level 80 with a Demon Hunter Timerunner and earning the achievement Timerunner: Demon Hunter"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(12, "Chasseur de démons"), C_ClassColor.GetClassColor("DEMONHUNTER")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61087)) or "Timerunner: Demon Hunter")
L["Obtainable for free by reaching level 80 with a Druid Timerunner and earning the achievement Timerunner: Druid"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(11, "Druide"), C_ClassColor.GetClassColor("DRUID")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61086)) or "Timerunner: Druid")
L["Obtainable for free by reaching level 80 with a Hunter Timerunner and earning the achievement Timerunner: Hunter"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(3, "Chasseur"), C_ClassColor.GetClassColor("HUNTER")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42687)) or "Timerunner: Hunter")
L["Obtainable for free by reaching level 80 with a Mage Timerunner and earning the achievement Timerunner: Mage"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(8, "Mage"), C_ClassColor.GetClassColor("MAGE")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61089)) or "Timerunner: Mage")
L["Obtainable for free by reaching level 80 with a Monk Timerunner and earning the achievement Timerunner: Monk"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(10, "Moine"), C_ClassColor.GetClassColor("MONK")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61085)) or "Timerunner: Monk")
L["Obtainable for free by reaching level 80 with a Paladin Timerunner and earning the achievement Timerunner: Paladin"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(2, "Paladin"), C_ClassColor.GetClassColor("PALADIN")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42504)) or "Timerunner: Paladin")
L["Obtainable for free by reaching level 80 with a Priest Timerunner and earning the achievement Timerunner: Priest"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(5, "Prêtre"), C_ClassColor.GetClassColor("PRIEST")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61088)) or "Timerunner: Priest")
L["Obtainable for free by reaching level 80 with a Rogue Timerunner and earning the achievement Timerunner: Rogue"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(4, "Voleur"), C_ClassColor.GetClassColor("ROGUE")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61084)) or "Timerunner: Rogue")
L["Obtainable for free by reaching level 80 with a Shaman Timerunner and earning the achievement Timerunner: Shaman"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(7, "Chaman"), C_ClassColor.GetClassColor("SHAMAN")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42686)) or "Timerunner: Shaman")
L["Obtainable for free by reaching level 80 with a Warlock Timerunner and earning the achievement Timerunner: Warlock"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(9, "Démoniste"), C_ClassColor.GetClassColor("WARLOCK")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61090)) or "Timerunner: Warlock")
L["Obtainable for free by reaching level 80 with a Warrior Timerunner and earning the achievement Timerunner: Warrior"] = "Obtenable gratuitement en atteignant le niveau 80 avec un Chronocoureur "..WrapTextInColor(ICH_GetClassName(1, "Guerrier"), C_ClassColor.GetClassColor("WARRIOR")).." et en obtenant l'accomplissement "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42684)) or "Timerunner: Warrior")
...
--- Sorting & Favorites ---
L["Favorites"] = "Favoris"
L["Click to favorite. Favorites always appear at the top of the list."] = "Cliquez pour ajouter aux favoris. Les favoris apparaissent toujours en haut de la liste."
L["Click to unfavorite"] = "Cliquez pour retirer des favoris"
L["Sort ascending"] = "Trier par ordre croissant"
L["Sort descending"] = "Trier par ordre décroissant"
L["Clear sort"] = "Effacer le tri"

--- World Tour ---
L["World Tour"] = "Tournée Mondiale"
L["No world tour stop selected"] = "Aucune étape de la tournée mondiale sélectionnée"
L["Start"] = "Démarrer"
L["Stop"] = "Arrêter"
L["Prev"] = "Précédent"
L["Next"] = "Suivant"
L["Reset"] = "Réinitialiser"
L["Select at least one collectible type to continue the tour"] = "Sélectionnez au moins un type d'objet à collectionner pour continuer la tournée"
L["Invalid world tour command."] = "Commande de tournée mondiale invalide."
