...
L["Requires four (4) Delicious Sporesnack that are earned after killing Rotmire on any difficulty."] = "Requiere cuatro (4) "..(select(2, C_Item.GetItemInfo(269245)) or EPIC_PURPLE_COLOR:WrapTextInColorCode("[Delicious Sporesnack]")).." que se obtienen después de matar a "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Cienagadumbre").." en cualquier dificultad."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").." mostrará todas las coleccionables que se pueden obtener de una mazmorra"
...
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").." mostrará todas las coleccionables obtenidas del Rey Exánime"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").." mostrará todas las coleccionables de instancias en Rasganorte"
...
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").." mostrará todas las coleccionables de La ira del Rey Exánime o Cataclismo"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").." mostrará todas las coleccionables de mazmorra no disponibles en dificultad Heroica"
