...
L["May require completion of the quest NZOTH_ASSAULTS_QUEST to access raid entrances"] = "공격대 입구들에 접근하려면 |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 58582 or 58496) or select(1, UnitFactionGroup("player")) == "Horde" and "Return of the Black Prince" or "An Unwelcome Advisor").." 퀘스트를 완료해야 할 수도 있습니다"
...
L["Can only be looted and used by a Druid"] = WrapTextInColor(ICH_GetClassName(11, "드루이드"), C_ClassColor.GetClassColor("DRUID")).."만 획득하고 사용할 수 있습니다"
...
L["Can only be looted and used by a Demon Hunter"] = WrapTextInColor(ICH_GetClassName(12, "악마사냥꾼"), C_ClassColor.GetClassColor("DEMONHUNTER")).."만 획득하고 사용할 수 있습니다"
...
L["Access to the raid entrance requires completing the quest ETERNAL_PALACE_QUEST"] = "공격대 입구에 접근하려면 |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 55799 or 56325) or select(1, UnitFactionGroup("player")) == "Horde" and "조류의 전환" or "전환점").." 퀘스트를 완료해야 합니다"
...
L["Show Available Only"] = "획득 가능한 항목만 표시"
L["Only show items that can still be collected"] = "아직 수집할 수 있는 항목만 표시합니다"
L["Also show collectibles you already own"] = "이미 보유한 수집품도 표시합니다"
L["Use TomTom waypoints instead of Blizzard map pins"] = "Blizzard 지도 핀 대신 TomTom 경유지를 사용합니다"
L["Show Owned"] = "보유 항목 표시"
L["How To Use:"] = "사용 방법:"
L["Find the collectible you want to collect in the list and click the button for the difficulty you want to run on to make sure it is updated."] = "목록에서 수집하려는 수집품을 찾아 실행할 난이도의 버튼을 클릭하세요. 업데이트되었는지 확인하세요."
...
L["A button will also be disabled for legacy raids completed on another difficulty since those lockouts are shared across difficulties."] = "다른 난이도에서 완료한 고대 공격대의 버튼도 비활성화됩니다. 해당 잠금은 난이도 간에 공유됩니다."
L["Click the star icon on any item to mark or unmark it as a favorite. Favorited items are always pinned to the top of the list."] = "항목의 별 아이콘을 클릭하여 즐겨찾기로 추가하거나 제거할 수 있습니다. 즐겨찾기 항목은 항상 목록 상단에 고정됩니다."
L["Click a column header to sort the list by that column. Click again to reverse the order, or a third time to clear the sort."] = "열 헤더를 클릭하여 해당 열을 기준으로 목록을 정렬합니다. 다시 클릭하면 순서가 반전되고, 세 번째 클릭하면 정렬이 해제됩니다."
L["Click on a collectible's icon to preview it in a dressing room window."] = "수집품의 아이콘을 클릭하면 드레싱룸 창에서 미리 볼 수 있습니다."
L["Use the checkboxes at the bottom of the window to control which items appear in the list."] = "창 하단의 체크박스를 사용하여 목록에 표시되는 항목을 제어합니다."
L["Enable the mini-window in settings or with /ich mini to see available collectibles while inside an instance."] = "설정에서 또는 "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich mini").."로 미니 창을 활성화하면 인스턴스 내에서 수집 가능한 항목을 볼 수 있습니다."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").."은(는) 던전에서 수집할 수 있는 모든 수집품 표시"
...
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").."은(는) 리치 왕에게서 획득 가능한 모든 수집품 표시"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").."은(는) 노스렌드 인스턴스에서 얻을 수 있는 모든 수집품 표시"
L["Other expansion abbreviations are also supported: tbc, cata, mop, wod, bfa, sl, df, tww"] = "다른 확장팩 약어도 지원됩니다: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tbc")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("cata")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("mop")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("wod")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("bfa")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("sl")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("df")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tww")
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").."은(는) 리치 왕의 분노 또는 대격변에서 얻을 수 있는 모든 수집품 표시"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").."은(는) 영웅 난이도에서 얻을 수 없는 모든 던전 수집품 표시"
L["Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. (wrath|cata) !heroic"] = "기본적으로 인접한 검색어는 AND로 결합됩니다. 괄호를 사용하여 검색어를 그룹화할 수 있습니다. 예: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("(wrath|cata) !heroic")
L["Name"] = "이름"
L["Instance"] = "인스턴스"
...
L["Waypoint tracking on the minimap may not always appear until you are in a specific zone. For example, an arrow pointing towards Throne of Thunder will only appear when you are on the Isle of Thunder."] = "미니맵의 경유지 추적은 특정 지역에 있을 때만 나타날 수 있습니다. 예를 들어, "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("천둥의 왕좌").."를 향한 화살표는 "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("천둥의 섬").."에 있을 때만 나타납니다."
...
L["Obtainable for free by reaching level 80 with a Death Knight Timerunner and earning the achievement Timerunner: Death Knight"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(6, "죽음의 기사"), C_ClassColor.GetClassColor("DEATHKNIGHT")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(6, "죽음의 기사"), C_ClassColor.GetClassColor("DEATHKNIGHT")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42685)) or "Timerunner: Death Knight")
L["Obtainable for free by reaching level 80 with a Demon Hunter Timerunner and earning the achievement Timerunner: Demon Hunter"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(12, "악마사냥꾼"), C_ClassColor.GetClassColor("DEMONHUNTER")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(12, "악마사냥꾼"), C_ClassColor.GetClassColor("DEMONHUNTER")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61087)) or "Timerunner: Demon Hunter")
L["Obtainable for free by reaching level 80 with a Druid Timerunner and earning the achievement Timerunner: Druid"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(11, "드루이드"), C_ClassColor.GetClassColor("DRUID")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(11, "드루이드"), C_ClassColor.GetClassColor("DRUID")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61086)) or "Timerunner: Druid")
L["Obtainable for free by reaching level 80 with a Hunter Timerunner and earning the achievement Timerunner: Hunter"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(3, "사냥꾼"), C_ClassColor.GetClassColor("HUNTER")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(3, "사냥꾼"), C_ClassColor.GetClassColor("HUNTER")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42687)) or "Timerunner: Hunter")
L["Obtainable for free by reaching level 80 with a Mage Timerunner and earning the achievement Timerunner: Mage"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(8, "마법사"), C_ClassColor.GetClassColor("MAGE")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(8, "마법사"), C_ClassColor.GetClassColor("MAGE")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61089)) or "Timerunner: Mage")
L["Obtainable for free by reaching level 80 with a Monk Timerunner and earning the achievement Timerunner: Monk"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(10, "수도사"), C_ClassColor.GetClassColor("MONK")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(10, "수도사"), C_ClassColor.GetClassColor("MONK")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61085)) or "Timerunner: Monk")
L["Obtainable for free by reaching level 80 with a Paladin Timerunner and earning the achievement Timerunner: Paladin"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(2, "성기사"), C_ClassColor.GetClassColor("PALADIN")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(2, "성기사"), C_ClassColor.GetClassColor("PALADIN")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42504)) or "Timerunner: Paladin")
L["Obtainable for free by reaching level 80 with a Priest Timerunner and earning the achievement Timerunner: Priest"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(5, "사제"), C_ClassColor.GetClassColor("PRIEST")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(5, "사제"), C_ClassColor.GetClassColor("PRIEST")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61088)) or "Timerunner: Priest")
L["Obtainable for free by reaching level 80 with a Rogue Timerunner and earning the achievement Timerunner: Rogue"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(4, "도적"), C_ClassColor.GetClassColor("ROGUE")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(4, "도적"), C_ClassColor.GetClassColor("ROGUE")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61084)) or "Timerunner: Rogue")
L["Obtainable for free by reaching level 80 with a Shaman Timerunner and earning the achievement Timerunner: Shaman"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(7, "주술사"), C_ClassColor.GetClassColor("SHAMAN")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(7, "주술사"), C_ClassColor.GetClassColor("SHAMAN")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42686)) or "Timerunner: Shaman")
L["Obtainable for free by reaching level 80 with a Warlock Timerunner and earning the achievement Timerunner: Warlock"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(9, "흑마법사"), C_ClassColor.GetClassColor("WARLOCK")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(9, "흑마법사"), C_ClassColor.GetClassColor("WARLOCK")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61090)) or "Timerunner: Warlock")
L["Obtainable for free by reaching level 80 with a Warrior Timerunner and earning the achievement Timerunner: Warrior"] = "레벨 80의 "..WrapTextInColor(ICH_GetClassName(1, "전사"), C_ClassColor.GetClassColor("WARRIOR")).." 타임러너로 타임러너: "..WrapTextInColor(ICH_GetClassName(1, "전사"), C_ClassColor.GetClassColor("WARRIOR")).." 업적을 달성하면 무료로 획득 가능: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42684)) or "Timerunner: Warrior")
...
--- World Tour ---
L["World Tour"] = "월드 투어"
L["No world tour stop selected"] = "선택된 월드 투어 정거장이 없습니다"
L["Start"] = "시작"
L["Stop"] = "중지"
L["Prev"] = "이전"
L["Next"] = "다음"
L["Reset"] = "초기화"
L["Select at least one collectible type to continue the tour"] = "투어를 계속하려면 하나 이상의 수집품 유형을 선택하세요"
L["Invalid world tour command."] = "잘못된 월드 투어 명령입니다."
