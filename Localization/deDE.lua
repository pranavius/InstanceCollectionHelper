...
L["Unable to transfer Timewarped Badges to this character right now."] = "Das Übertragen von Zeitverzerrtes Abzeichen auf diesen Charakter ist derzeit nicht möglich."
...
L["Obtainable for free by reaching level 80 with a Death Knight Timerunner and earning the achievement Timerunner: Death Knight"] = "Kostenlos erhältlich, wenn du mit einem Todesritter-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(42685)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Death Knight")).." erreichst"
L["Obtainable for free by reaching level 80 with a Demon Hunter Timerunner and earning the achievement Timerunner: Demon Hunter"] = "Kostenlos erhältlich, wenn du mit einem Dämonenjäger-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61087)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Demon Hunter")).." erreichst"
L["Obtainable for free by reaching level 80 with a Druid Timerunner and earning the achievement Timerunner: Druid"] = "Kostenlos erhältlich, wenn du mit einem Druiden-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61086)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Druid")).." erreichst"
L["Obtainable for free by reaching level 80 with a Hunter Timerunner and earning the achievement Timerunner: Hunter"] = "Kostenlos erhältlich, wenn du mit einem Jäger-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(42687)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Hunter")).." erreichst"
L["Obtainable for free by reaching level 80 with a Mage Timerunner and earning the achievement Timerunner: Mage"] = "Kostenlos erhältlich, wenn du mit einem Magier-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61089)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Mage")).." erreichst"
L["Obtainable for free by reaching level 80 with a Monk Timerunner and earning the achievement Timerunner: Monk"] = "Kostenlos erhältlich, wenn du mit einem Mönch-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61085)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Monk")).." erreichst"
L["Obtainable for free by reaching level 80 with a Paladin Timerunner and earning the achievement Timerunner: Paladin"] = "Kostenlos erhältlich, wenn du mit einem Paladin-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(42504)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Paladin")).." erreichst"
L["Obtainable for free by reaching level 80 with a Priest Timerunner and earning the achievement Timerunner: Priest"] = "Kostenlos erhältlich, wenn du mit einem Priester-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61088)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Priest")).." erreichst"
L["Obtainable for free by reaching level 80 with a Rogue Timerunner and earning the achievement Timerunner: Rogue"] = "Kostenlos erhältlich, wenn du mit einem Schurken-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61084)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Rogue")).." erreichst"
L["Obtainable for free by reaching level 80 with a Shaman Timerunner and earning the achievement Timerunner: Shaman"] = "Kostenlos erhältlich, wenn du mit einem Schamanen-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(42686)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Shaman")).." erreichst"
L["Obtainable for free by reaching level 80 with a Warlock Timerunner and earning the achievement Timerunner: Warlock"] = "Kostenlos erhältlich, wenn du mit einem Hexenmeister-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(61090)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Warlock")).." erreichst"
L["Obtainable for free by reaching level 80 with a Warrior Timerunner and earning the achievement Timerunner: Warrior"] = "Kostenlos erhältlich, wenn du mit einem Krieger-Timerunner Level 80 erreichst und die Errungenschaft "..(select(2, GetAchievementInfo(42684)) or DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Timerunner: Warrior")).." erreichst"
L["This pet is a reward from a quest chain started by the item Strange Humming Crystal, which is purchasable from the vendor."] = "Dieses Haustier ist die Belohnung einer Questreihe, die durch den Gegenstand "..(select(2, C_Item.GetItemInfo(141349)) or WHITE_FONT_COLOR:WrapTextInColorCode("[Strange Humming Crystal]")).." gestartet wird, welcher beim Händler kaufbar ist."
