...
L["Requires completing the Tazavesh storyline to unlock flight path, beginning with The Al'ley Cat of Oribos"] = "Erfordert den Abschluss der Tazavesh-Handlung, um den Flugpunkt von Oribos freizuschalten, beginnend mit |A:QuestNormal:15:15|a"..WrapTextInColor(C_QuestLog.GetTitleForQuestID(63976) or "Al'ter Gauner von Oribos", DARKYELLOW_FONT_COLOR)
L["Requires completing a short questline after looting Malfunctioning Mechsuit"] = "Erfordert das Abschließen einer kurzen Questreihe nach dem Plündern von "..(select(2, C_Item.GetItemInfo(226683)) or WrapTextInColor("[Defekter Mechanzug]", EPIC_PURPLE_COLOR))
...
L["Requires completion of the achievement Relics of a Fallen Empire"] = "Erfordert den Abschluss der Errungenschaft "..WrapTextInColor(select(2, GetAchievementInfo(17366)) or "Relics of a Fallen Empire", DARKYELLOW_FONT_COLOR)
...
L["This item is obtainable even though it does not appear on the loot table for Goldie Baronbottom"] = "Dieser Gegenstand ist erhältlich, obwohl er nicht in der Beutetabelle von "..WrapTextInColor("Goldie Barontasch", DARKYELLOW_FONT_COLOR).." erscheint"
...
L["Dropped by Deviate Guardians and Deviate Ravagers throughout the dungeon"] = "Drop von "..WrapTextInColor("Deviatwächter", DARKYELLOW_FONT_COLOR).." und "..WrapTextInColor("Deviatverheerer", DARKYELLOW_FONT_COLOR).." im gesamten Dungeon"
L["Dropped by the Rare Elite Gol'than the Malodorous"] = "Drop von dem seltenen Elitegegner "..WrapTextInColor("Gol'than der Übelriechende", DARKYELLOW_FONT_COLOR)
...
L["Dropped by Defias Pirates on the boat towards the end of the dungeon"] = "Drop von "..WrapTextInColor("Defiaspiraten", DARKYELLOW_FONT_COLOR).." auf dem Boot gegen Ende des Dungeons"
L["Dropped by The Lanticore, which has a random chance to spawn after killing Orebender Gor'ashan"] = "Drop von "..WrapTextInColor("Der Lantikor", DARKYELLOW_FONT_COLOR)..", der mit zufälliger Chance erscheint, nachdem "..WrapTextInColor("Erzformer Gor'ashan", DARKYELLOW_FONT_COLOR).." getötet wurde"
L["Access to the raid entrance requires completing the quest ETERNAL_PALACE_QUEST"] = "Der Zugang zum Raid-Eingang erfordert das Abschließen der Quest |A:QuestNormal:15:15|a"..WrapTextInColor(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 55799 or 56325) or "Das Blatt wendet sich", DARKYELLOW_FONT_COLOR)
L["Dropped by Sand Elementals in Normal and Heroic, but can be looted from Council of Elders in LFR"] = "Drop von "..WrapTextInColor("Sandelementare", DARKYELLOW_FONT_COLOR).." in Normal und Heroisch, kann aber im LFR vom "..WrapTextInColor("Rat der Ältesten", DARKYELLOW_FONT_COLOR).." geplündert werden"
L["Obtained by using an Amani Hex Stick on Forest Frogs"] = "Erhältlich durch Verwendung eines "..(select(2, C_Item.GetItemInfo(33865)) or WrapTextInColor("[Hexerstecken der Amani]", GREEN_FONT_COLOR)).." auf "..WrapTextInColor("Urwaldfrösche", DARKYELLOW_FONT_COLOR)
...
L["This item is obtainable even though it does not appear on the loot table for Dragons of Nightmare"] = "Dieser Gegenstand ist erhältlich, obwohl er nicht in der Beutetabelle von "..WrapTextInColor("Drachen des Alptraums", DARKYELLOW_FONT_COLOR).." erscheint"
L["This pet takes 3 days to hatch after looting Viable Cobra Egg"] = "Dieses Haustier braucht 3 Tage zum Schlüpfen, nachdem man "..(select(2, C_Item.GetItemInfo(160832)) or WrapTextInColor("[Lebensfähiges Kobraei]", RARE_BLUE_COLOR)).." geplündert hat"
L["This item is obtainable even though it does not appear on the loot table for Sire Denathrius"] = "Dieser Gegenstand ist erhältlich, obwohl er nicht in der Beutetabelle von "..WrapTextInColor("Graf Denathrius", DARKYELLOW_FONT_COLOR).." erscheint"
...
L["\"raid\" will show all collectibles that can be collected from a raid"] = WrapTextInColor("\"raid\"", DARKYELLOW_FONT_COLOR).." zeigt alle Sammelobjekte, die aus einem Schlachtzug gesammelt werden können."
L["\"10\" will show all collectibles that can be collected from a legacy 10 player raid (Normal or Heroic)"] = WrapTextInColor("\"10\"", DARKYELLOW_FONT_COLOR).." zeigt alle Sammelobjekte, die aus einem klassischen 10-Spieler-Schlachtzug (Normal oder Heroisch) gesammelt werden können."
L["\"fel\" will show all collectibles and instances that contain \"fel\" in the name"] = WrapTextInColor("\"fel\"", DARKYELLOW_FONT_COLOR).." zeigt alle Sammelobjekte und Instanzen, die \"fel\" im Namen enthalten."
L["\"mythic\" will show all collectibles that can be obtained from a Mythic dungeon or raid"] = WrapTextInColor("\"mythisch\"", DARKYELLOW_FONT_COLOR).." zeigt alle Sammelobjekte, die aus einem mythischen Dungeon oder Schlachtzug gesammelt werden können."
L["\"lfr\" will show all collectibles that can be obtained from Raid Finder (LFR) difficulty raids"] = WrapTextInColor("\"lfr\"", DARKYELLOW_FONT_COLOR).." zeigt alle Sammelobjekte, die im Schlachtzugsbrowser (LFR) gesammelt werden können."
