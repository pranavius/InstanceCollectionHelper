...
L["Can only be looted and used by a Druid"] = "仅限"..WrapTextInColor(select(1, GetClassInfo(11)), ICH_GetClassColor("DRUID")).."拾取并使用"
...
L["Can only be looted and used by a Demon Hunter"] = "仅限"..WrapTextInColor(select(1, GetClassInfo(12)), ICH_GetClassColor("DEMONHUNTER")).."拾取并使用"
