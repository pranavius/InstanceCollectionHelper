...
L["May require completion of the quest NZOTH_ASSAULTS_QUEST to access raid entrances"] = "L'accesso agli ingressi dell'incursione potrebbe richiedere il completamento della missione |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 58582 or 58496) or select(1, UnitFactionGroup("player")) == "Horde" and "Return of the Black Prince" or "An Unwelcome Advisor")
...
L["Requires four (4) Delicious Sporesnack that are earned after killing Rotmire on any difficulty."] = "Richiede quattro (4) "..(select(2, C_Item.GetItemInfo(269245)) or EPIC_PURPLE_COLOR:WrapTextInColorCode("[Delicious Sporesnack]")).." che si ottengono sconfiggendo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Fangorrido").." in qualsiasi modalità."
...
L["Can only be looted and used by a Druid"] = "Può essere saccheggiato e usato solo da un "..WrapTextInColor(ICH_GetClassName(11, "Druid"), C_ClassColor.GetClassColor("DRUID"))
...
L["Can only be looted and used by a Demon Hunter"] = "Può essere saccheggiato e usato solo da un "..WrapTextInColor(ICH_GetClassName(12, "Demon Hunter"), C_ClassColor.GetClassColor("DEMONHUNTER"))
...
L["Access to the raid entrance requires completing the quest ETERNAL_PALACE_QUEST"] = "L'accesso all'ingresso dell'incursione richiede il completamento della missione |A:QuestNormal:15:15|a"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(C_QuestLog.GetTitleForQuestID(select(1, UnitFactionGroup("player")) == "Horde" and 55799 or 56325) or select(1, UnitFactionGroup("player")) == "Horde" and "La marea volta" or "Quando la marea volta")
...
--- Icon Tooltip ---
L["Track available collectibles from instances and easily set required instance difficulty"] = "Traccia gli oggetti da collezione disponibili dalle istanze e imposta facilmente la difficoltà istanza richiesta"
L["Click to open the AddOn window"] = GREEN_FONT_COLOR:WrapTextInColorCode("Clic").." per aprire la finestra dell'addon"
L["Right-click to open the settings window"] = GREEN_FONT_COLOR:WrapTextInColorCode("Clic destro").." per aprire la finestra delle impostazioni"
L["Type /ich help in the chat window for available slash commands"] = "Digita "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich help").." nella finestra chat per i comandi disponibili"
...
L["Show Available Only"] = "Mostra solo disponibili"
L["Only show items that can still be collected"] = "Mostra solo gli oggetti che possono ancora essere raccolti"
L["Also show collectibles you already own"] = "Mostra anche i collezionabili già posseduti"
L["Use TomTom waypoints instead of Blizzard map pins"] = "Usa i waypoint TomTom invece dei segnaposto mappa di Blizzard"
L["Show Owned"] = "Mostra posseduti"
L["How To Use:"] = "Come usare:"
L["Find the collectible you want to collect in the list and click the button for the difficulty you want to run on to make sure it is updated."] = "Trova il collezionabile desiderato nella lista e clicca sul pulsante per la difficoltà scelta per assicurarti che sia aggiornata."
...
L["A button will also be disabled for legacy raids completed on another difficulty since those lockouts are shared across difficulties."] = "Un pulsante sarà disabilitato anche per le incursioni eredità completate in un'altra difficoltà poiché quei blocchi sono condivisi tra le difficoltà."
L["Click the star icon on any item to mark or unmark it as a favorite. Favorited items are always pinned to the top of the list."] = "Clicca sull'icona a stella di qualsiasi oggetto per aggiungerlo o rimuoverlo dai preferiti. I preferiti sono sempre mostrati in cima alla lista."
L["Click a column header to sort the list by that column. Click again to reverse the order, or a third time to clear the sort."] = "Clicca sull'intestazione di una colonna per ordinare la lista in base a quella colonna. Clicca di nuovo per invertire l'ordine, o una terza volta per rimuovere l'ordinamento."
L["Click on a collectible's icon to preview it in a dressing room window."] = "Clicca sull'icona di un collezionabile per visualizzarne un'anteprima nella finestra del camerino."
L["Use the checkboxes at the bottom of the window to control which items appear in the list."] = "Usa le caselle di controllo nella parte inferiore della finestra per controllare quali oggetti appaiono nella lista."
L["Enable the mini-window in settings or with /ich mini to see available collectibles while inside an instance."] = "Attiva la mini-finestra nelle impostazioni o con "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("/ich mini").." per vedere i collezionabili disponibili all'interno di un'istanza."
...
L["dungeon will show all collectibles that can be collected from a dungeon"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon\"").." mostrerà tutti i collezionabili ottenibili da una spedizione"
...
L["lich king will show all collectibles dropped by The Lich King"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"lich king\"").." mostrerà tutti i collezionabili ottenuti dal Re dei Non Morti"
L["northrend will show all collectibles from instances in Northrend"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"northrend\"").." mostrerà tutti i collezionabili dalle istanze di Norderon"
L["Other expansion abbreviations are also supported: tbc, cata, mop, wod, bfa, sl, df, tww"] = "Sono supportate anche altre abbreviazioni di espansione: "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tbc")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("cata")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("mop")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("wod")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("bfa")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("sl")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("df")..", "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("tww")
L["wrath|cata will show all collectibles from Wrath of the Lich King or Cataclysm"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"wrath|cata\"").." mostrerà tutti i collezionabili di Wrath of the Lich King o Cataclysm"
L["dungeon !heroic will show all dungeon collectibles not available on Heroic difficulty"] = DARKYELLOW_FONT_COLOR:WrapTextInColorCode("\"dungeon !heroic\"").." mostrerà tutti i collezionabili da spedizione non disponibili nella difficoltà Eroica"
L["Adjacent terms are combined with AND by default. Use parentheses to group terms, e.g. (wrath|cata) !heroic"] = "I termini adiacenti sono combinati con AND per impostazione predefinita. Usa le parentesi per raggruppare i termini, ad es. "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("(wrath|cata) !heroic")
L["Name"] = "Nome"
L["Instance"] = "Istanza"
...
L["Waypoint tracking on the minimap may not always appear until you are in a specific zone. For example, an arrow pointing towards Throne of Thunder will only appear when you are on the Isle of Thunder."] = "Il tracciamento del waypoint sulla minimappa potrebbe non apparire finché non sei in una zona specifica. Per esempio, una freccia che punta verso il "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Regno del Tuono").." apparirà solo quando sei sull'"..DARKYELLOW_FONT_COLOR:WrapTextInColorCode("Isola del Tuono").."."
...
L["Originally rewarded for completing the achievement Master of the Turbulent Timeways IV. Can now be purchased from any Timewalking vendor."] = "Originariamente assegnato completando il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61394)) or "Master of the Turbulent Timeways IV")..". Ora può essere acquistato da qualsiasi Mercante del Camminacronos"
...
L["Obtainable for free by reaching level 80 with a Death Knight Timerunner and earning the achievement Timerunner: Death Knight"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(6, "Cavaliere della Morte"), C_ClassColor.GetClassColor("DEATHKNIGHT")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42685)) or "Timerunner: Death Knight")
L["Obtainable for free by reaching level 80 with a Demon Hunter Timerunner and earning the achievement Timerunner: Demon Hunter"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(12, "Cacciatore di Demoni"), C_ClassColor.GetClassColor("DEMONHUNTER")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61087)) or "Timerunner: Demon Hunter")
L["Obtainable for free by reaching level 80 with a Druid Timerunner and earning the achievement Timerunner: Druid"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(11, "Druido"), C_ClassColor.GetClassColor("DRUID")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61086)) or "Timerunner: Druid")
L["Obtainable for free by reaching level 80 with a Hunter Timerunner and earning the achievement Timerunner: Hunter"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(3, "Cacciatore"), C_ClassColor.GetClassColor("HUNTER")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42687)) or "Timerunner: Hunter")
L["Obtainable for free by reaching level 80 with a Mage Timerunner and earning the achievement Timerunner: Mage"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(8, "Mago"), C_ClassColor.GetClassColor("MAGE")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61089)) or "Timerunner: Mage")
L["Obtainable for free by reaching level 80 with a Monk Timerunner and earning the achievement Timerunner: Monk"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(10, "Monaco"), C_ClassColor.GetClassColor("MONK")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61085)) or "Timerunner: Monk")
L["Obtainable for free by reaching level 80 with a Paladin Timerunner and earning the achievement Timerunner: Paladin"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(2, "Paladino"), C_ClassColor.GetClassColor("PALADIN")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42504)) or "Timerunner: Paladin")
L["Obtainable for free by reaching level 80 with a Priest Timerunner and earning the achievement Timerunner: Priest"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(5, "Sacerdote"), C_ClassColor.GetClassColor("PRIEST")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61088)) or "Timerunner: Priest")
L["Obtainable for free by reaching level 80 with a Rogue Timerunner and earning the achievement Timerunner: Rogue"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(4, "Ladro"), C_ClassColor.GetClassColor("ROGUE")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61084)) or "Timerunner: Rogue")
L["Obtainable for free by reaching level 80 with a Shaman Timerunner and earning the achievement Timerunner: Shaman"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(7, "Sciamano"), C_ClassColor.GetClassColor("SHAMAN")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42686)) or "Timerunner: Shaman")
L["Obtainable for free by reaching level 80 with a Warlock Timerunner and earning the achievement Timerunner: Warlock"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(9, "Stregone"), C_ClassColor.GetClassColor("WARLOCK")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(61090)) or "Timerunner: Warlock")
L["Obtainable for free by reaching level 80 with a Warrior Timerunner and earning the achievement Timerunner: Warrior"] = "Ottenibile gratuitamente raggiungendo il livello 80 con un Corritempo "..WrapTextInColor(ICH_GetClassName(1, "Guerriero"), C_ClassColor.GetClassColor("WARRIOR")).." e ottenendo il traguardo "..DARKYELLOW_FONT_COLOR:WrapTextInColorCode(select(2, GetAchievementInfo(42684)) or "Timerunner: Warrior")
...
L["Click to favorite. Favorites always appear at the top of the list."] = "Clicca per aggiungere ai preferiti. I preferiti appaiono sempre in cima alla lista."
L["Click to unfavorite"] = "Clicca per rimuovere dai preferiti"
L["Sort ascending"] = "Ordina in modo crescente"
L["Sort descending"] = "Ordina in modo decrescente"
L["Clear sort"] = "Rimuovi ordinamento"

--- World Tour ---
L["World Tour"] = "Tour Mondiale"
L["No world tour stop selected"] = "Nessuna tappa del tour mondiale selezionata"
L["Start"] = "Avvia"
L["Stop"] = "Interrompi"
L["Prev"] = "Precedente"
L["Next"] = "Successivo"
L["Reset"] = "Reimposta"
L["Select at least one collectible type to continue the tour"] = "Seleziona almeno un tipo di collezionabile per continuare il tour"
L["Invalid world tour command."] = "Comando del tour mondiale non valido."
