...
function AddOn:CreateTabSystem()
    ...
    -- self:CreateTab("Housing", false)
    self:CreateTab("Housing")
    -- self.Tabs:GetTabButton(self.Tabs.HousingTab):SetTooltipText(L["Coming soon"].."™")
    self.Tabs:GetTabButton(self.Tabs.HousingTab)
