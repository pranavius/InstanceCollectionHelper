...
Updates such as filtering the list by mount, instance, or difficulty are planned very soon. In the immediate future, this aims to solve the problem of the correct instance difficulty not being set due to confusion when changing settings from the default UI.
